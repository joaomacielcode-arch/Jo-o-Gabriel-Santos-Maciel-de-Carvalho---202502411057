...
def carregar_dados():
    ...
    df["cat_sal_list"] = len(df["categoria_salario"])
    return df
...
catsal_filtro = st.sidebar.selectbox(
    "Categoria Salarial",
    ("Alto","Médio","Baixo")
)
...
df_filtrado = df[
    ...
    (df["categoria_salario"] == catsal_filtro)
]
